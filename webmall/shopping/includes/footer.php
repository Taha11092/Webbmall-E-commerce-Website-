...
<h3>web mall</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> We believe in Best quality and effective price delivering to our customers .</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(+91) 9993334533<br>(+91)0909999676</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">medicaps.ac.in</a></span>
                </div>
            </li>
